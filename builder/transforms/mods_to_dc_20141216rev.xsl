...
-->
	...
	<xsl:template match="mods:subject[mods:topic | mods:name | mods:occupation | mods:hierarchicalGeographic | mods:cartographics | mods:temporal] ">
		<dc:subject>
	...
	<xsl:template match="mods:subject[@authority='lcsh'][mods:geographic]" >
